...
const meme = document.querySelector(".meme-container");
  ...
  const revealed = document.querySelector(".reveal-container");
...
function showJoke() {
  ...
  //const randomMemeUrl = getRandomData('memes');
   var p = document.createElement('p');
            p.textContent = randomJokeText;
  const container=document.querySelector(".joke-container");
  var pnew=container.querySelector("p");
...
function showRiddle() {
  ...
  //const randomMemeUrl = getRandomData('memes');
   var p = document.createElement('p');
            p.textContent = randomRiddle.question ;
  const container=document.querySelector(".riddle-container");
  var ans = document.createElement('p');
            ans.textContent = randomRiddle.answer ;
  ...
  
  {
    ...
    revealContainer.appendChild(ans);
...
function revealAnswers() {
  ...
  if(revealContainer)
    {
      const revealed =    revealContainer.querySelector("#answer");
     
      if(revealed.style.display === "block")
        {
